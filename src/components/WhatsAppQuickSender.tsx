      ...
      <AnimatePresence>
        {showPanel && (
          <motion.div
            ...
            className="fixed right-4 bottom-40 bg-black border-2 border-[#FFD700] rounded-2xl p-4 z-40 w-96 max-h-[500px] overflow-y-auto"
          >
            ...
            {pendingBookings.length === 0 ? (
              ...
              <div className="space-y-3">
                {pendingBookings.map((booking) => (
                  <div
                    key={booking.id}
                    className="bg-zinc-900 border border-[#FFD700]/30 rounded-xl p-3"
                  >
                    {/* Booking Info */}
                    <div className="mb-3">
                      ...
                      <div className="text-sm text-[#FFD700]">{booking.service}</div>
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className="w-full px-3 py-2 bg-blue-600 text-white rounded-lg text-sm font-bold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-green-600 text-white rounded-lg text-sm font-bold hover:bg-green-700 transition-colors flex items-center justify-center gap-1"
                        >
                        ...
                        <button
                          ...
                          className="px-3 py-2 bg-red-600 text-white rounded-lg text-sm font-bold hover:bg-red-700 transition-colors flex items-center justify-center gap-1"
                        >
            ...
            <div className="mt-4 p-3 bg-zinc-900 rounded-lg">
              <p className="text-xs text-gray-400">
                ...
                1. Click "Send to Owner" → WhatsApp opens → Click Send<br />
                2. Click "Approve" → Customer WhatsApp opens → Click Send<br />
