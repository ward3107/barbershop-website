  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[10000] flex items-start justify-center p-4 pt-20"
      ...
      >
        <motion.div
          ...
          className="bg-gradient-to-br from-zinc-900 to-black border-2 border-[#FFD700]/30 rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto p-6 md:p-8 relative"
        >
