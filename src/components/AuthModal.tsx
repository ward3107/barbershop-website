...
export default function AuthModal({ open, onOpenChange }: AuthModalProps) {
  ...
  const { login, signup, loginWithGoogle, loginWithFacebook, loginWithApple, loginWithMicrosoft } = useAuth();
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full bg-[#1877F2] text-white font-bold py-3 rounded-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full bg-black text-white font-bold py-3 rounded-lg hover:shadow-lg hover:shadow-gray-500/50 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed border border-white"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full bg-white text-black font-bold py-3 rounded-lg hover:shadow-lg hover:shadow-blue-400/50 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed border-2 border-gray-300"
            >
