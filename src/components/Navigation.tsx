        ...
        <div className="container mx-auto px-3 md:px-4 flex justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-1 md:gap-4">
            ...
            <motion.button
              ...
              title="Admin Login"
            >
              <div className="w-9 h-9 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-[#FFD700] to-[#C4A572] p-[2px] shadow-lg shadow-[#FFD700]/50">
                <div className="w-full h-full rounded-full bg-black/90 flex items-center justify-center">
                  <Crown className="w-4 h-4 md:w-6 md:h-6 text-[#FFD700]" />
                </div>
              </div>
              {/* Animated pulse ring */}
